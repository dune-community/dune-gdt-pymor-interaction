...
export CXX=g++
export F77=gfortran
export CMAKE_FLAGS="-DMETIS_ROOT=$INSTALL_PREFIX -DBOOST_ROOT=$INSTALL_PREFIX -DEIGEN_INCLUDE_DIR=$INSTALL_PREFIX/include/eigen3 -DDUNE_XT_WITH_PYTHON_BINDINGS=TRUE -DTBB_INCLUDE_DIR=/opt/intel-tbb-4.2_20140601/usr/include -DTBB_LIBRARY_DIR=/opt/intel-tbb-4.2_20140601/usr/lib"
